...
## Besoin utilisateur  :
Est une exigence fonctinnelle ou non fonctionnel exprimé par un utilisateur final donc :
...
## Composants
Est un élément réutilisable dans Figma servant de modèle , modifier le composant principal met à jour toutes ses instances pour un cohérence garantit
